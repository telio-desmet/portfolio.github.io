...
<body>
    ...
    <div class="chat-container">
        ...
        <p>Chat avec un modèle Mistral AI en LLM local</p>
        ...
        fetch('/test')
            ...
            .then(data => {
                if (data.model_available) {
                    statusDiv.textContent = '✅ Mistral 7B connecté et prêt';
                    statusDiv.className = 'status success';
                } else {
                    statusDiv.textContent = '⚠️ Mistral 7B non disponible - Mode test activé';
